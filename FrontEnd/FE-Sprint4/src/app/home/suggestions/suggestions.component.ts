...
export class SuggestionsComponent implements OnInit {
  ...
  diplaymovies(){
    this.getapi.getTopFiveMovies().subscribe((results:User)=>{
      ...
      for(var counter:number =0;counter<5;counter++){
        this.suggestions.push(new Suggestions(JSON.stringify(results[counter]["Name"]),JSON.stringify(results[counter]["Genre"]), JSON.stringify(results[counter]["Desc"])  , 'https://m.media-amazon.com/images/I/91BT--NUiKL._AC_UY436_FMwebp_QL65_.jpg','https://material.angular.io/assets/img/examples/shiba1.jpg'))
      }
