...
export class SuggestionsComponent implements OnInit {
  ...
  suggestions: Suggestions[]=[
    new Suggestions('Title - 1','Genre 1', 'Title Description 1','https://material.angular.io/assets/img/examples/shiba2.jpg','https://material.angular.io/assets/img/examples/shiba1.jpg'),
